...
<div>
  ...
  <img style="border: 0;-ms-interpolation-mode: bicubic;display: block;Margin-left: auto;Margin-right: auto;max-width: 152px" src="<?php echo $logo; ?>" alt="" width="152" height="108"></div>
    ...
    <p style="Margin-top: 0;color: #565656;font-family: Georgia,serif;font-size: 16px;line-height: 25px;Margin-bottom: 25px">Weekly Entries - 600</p>
    <p style="Margin-top: 0;color: #565656;font-family: Georgia,serif;font-size: 16px;line-height: 25px;Margin-bottom: 25px">Payout (INR) - Minimum 2- Maximum 30/- (Depending upon the accuracy)</p>
   ...
   <p style="Margin-top: 0;color: #565656;font-family: Georgia,serif;font-size: 16px;line-height: 25px;Margin-bottom: 25px"> Project Duration - <?php echo $days; ?> Days  </p>
    ...
    <p style="Margin-top: 0;color: #565656;font-family: Georgia,serif;font-size: 16px;line-height: 25px;Margin-bottom: 25px">90% accuracy is required for INR 30- Payout per Resume. i.e 540 out of 600 must have to typed accurately (without any mistake) 
...
<p style="Margin-top: 0;color: #565656;font-family: Georgia,serif;font-size: 16px;line-height: 25px;Margin-bottom: 25px">Customer care no: <?php echo $customer_care_no;?> </p>
