...
$("#resume_form").validate({
    rules: {
        ...
        notionality: {required:true},
        mari_status: {required:true},
        passport: {required:true},
        hobbies: {required:true},
        lang_known: {required:true},
        address: {required:true},
        land_mark: {required:true},
        state: {required:true},
        city: {required:true},
        pincode: {required:true},
        mobile: {required:true},
        email: {required:true},
        ssc_result: {required:true},
        ssc_board_uni: {required:true},
        ssc_pass_year: {required:true},
        hsc_result: {required:true},
        hsc_pass_year: {required:true},
        hsc_uni: {required:true},
        dip_deg: {required:true},
        dip_res: {required:true},
        dip_uni: {required:true},
        dip_year: {required:true},
        gradu_deg: {required:true},
        gradu_res: {required:true},
        gradu_uni: {required:true},
        gradu_year: {required:true},
        post_grad_deg: {required:true},
        post_grad_res: {required:true},
        post_grad_uni: {required:true},
        post_grad_year: {required:true},
        high_lev_edu: {required:true},
        ttl_exp_year: {required:true},
        ttl_exp_mon: {required:true},
        company_work_for: {required:true},
        last_curr_emp: {required:true}
